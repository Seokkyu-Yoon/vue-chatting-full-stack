...
process.env.VUE_APP_DOWNLOAD_SERVER_IP = injectedEnv.DOWNLOAD_SERVER_IP || env.DOWNLOAD_SERVER_IP
process.env.VUE_APP_DOWNLOAD_SERVER_PORT = injectedEnv.DOWNLOAD_SERVER_PORT || env.DOWNLOAD_SERVER_PORT
